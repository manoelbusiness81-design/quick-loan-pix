...
export interface GovMaOpcao {
  prazo: number;
  parcela: number;
  valorLiberado: number;
}

export interface GovMaCardData {
  cliente: string;
  taxa: number;
  base: number;
  opcoes: GovMaOpcao[];
...
export const GovMaCard = forwardRef<HTMLDivElement, { data: GovMaCardData }>(({ data }, ref) => {
...
GovMaCard.displayName = "GovMaCard";
